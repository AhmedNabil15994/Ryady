    ...
    <head>
        ...
        <style>
            ...
            @font-face {
                ...
                src: url('{{ asset("/assets/fonts/Tajawal-Bold.ttf") }}') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            ...
            @font-face {
                ...
                src: url('{{ asset('/assets/fonts/Tajawal-ExtraBold.ttf') }}') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            /* ------------------------------------------ */
    ...
    <body>
        <div class="certificate">
            <center class="content">
                <img src="{{ asset('/assets/images/bgCER.png') }}" class="bgCer" alt="" />
                <img src="{{ asset('/assets/images/logo.svg') }}" class="logo" alt="" />
                <h2 class="title">شهادة عضوية</h2>
                <h3 class="subTitle">تصادق Business Pro للإستشارات</h3>
                <h4 class="name"><span>على مـنـح</span>     {{ $user }}</h4>
                <h5 class="subTitle2">عضوية  | {{ $membership_name }} الشاب الريادي</h5>
            ...
            <div class="cerFooter">
                <div class="col-xs-4 date">
                    <span class="text">رقـم الاعـتـمـاد # {{ $code }}-452673</span>
                    <span class="text">صلاحـيـة الشهادة الى {{ $end_date[0] . ' ' . $end_date[1] . ' ' . $end_date[2] }}</span>
                    <span class="text">معتمدة الشهادة منذ {{ $start_date[0] . ' ' . $start_date[1] . ' ' . $start_date[2] }}</span>
                </div>
