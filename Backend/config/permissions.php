...
return [
    ...
    'MembershipControllers@edit' => 'edit-member',
    'MembershipControllers@update' => 'edit-member',
    'MembershipControllers@fastEdit' => 'edit-member',
    'MembershipControllers@add' => 'add-member',
    'MembershipControllers@create' => 'add-member',
    'MembershipControllers@delete' => 'delete-member',
    'MembershipControllers@arrange' => 'sort-member',
    'MembershipControllers@sort' => 'sort-member',
    'MembershipControllers@charts' => 'charts-member',
    'MembershipControllers@uploadImage' => 'uploadImage-member',
    'MembershipControllers@deleteImage' => 'deleteImage-member',
