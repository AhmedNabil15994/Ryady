	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ Active(URL::to('/userCards*'),'menu-item-open active') }} {{ Active(URL::to('/userRequests*'),'menu-item-open active') }} {{ Active(URL::to('/cardPromotions*'),'menu-item-open active') }} {{ Active(URL::to('/userCertificates*'),'menu-item-open active') }}" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            @endif
                            @if(\Helper::checkRules('list-user-requests') && \App\Models\Variable::getVar('PRINTED_CARDS') == 1)
                ...
                @if(\Helper::checkRules('list-groups,list-users,list-admins,list-logs'))
                <li class="menu-item menu-item-submenu {{ Active(URL::to('/groups*'),'menu-item-open active') }} {{ Active(URL::to('/admins*'),'menu-item-open active') }} {{ Active(URL::to('/users*'),'menu-item-open active') }} {{ Active(URL::to('/logs*'),'menu-item-open active') }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
