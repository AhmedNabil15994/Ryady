...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-topMenu'))
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/topMenu') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-topMenu') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-topMenu') }}">
        <!--begin: Datatable-->
