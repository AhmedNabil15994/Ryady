        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/benefits') }}" class="text-muted">منهجيتنا</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    @if(\Helper::checkRules('add-benefit'))
                    <a href="{{ URL::to('/benefits/add') }}" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-plus"></i>
                        <span class="m-nav__link-text">اضافة</span>
                    </a>
                    @endif
                    @if(\Helper::checkRules('sort-benefit'))
                    <a href="{{ URL::to('/benefits/arrange') }}" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-sort-numeric-up"></i>
                        <span class="m-nav__link-text">ترتيب</span>
                    </a>
                    @endif
                    @if(\Helper::checkRules('charts-benefit'))
                    <a href="{{ URL::to('/benefits/charts') }}" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-benefit'))
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/benefits') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-benefit') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-benefit') }}">
        <!--begin: Datatable-->
