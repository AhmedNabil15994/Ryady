...
@section('title','تصنيفات المشاريع')
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/projectCategories') }}" class="text-muted">تصنيفات المشاريع</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    @if(\Helper::checkRules('add-project-category'))
                    <a href="{{ URL::to('/projectCategories/add') }}" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-plus"></i>
                        <span class="m-nav__link-text">اضافة</span>
                    </a>
                    @endif
                    @if(\Helper::checkRules('sort-project-category'))
                    <a href="{{ URL::to('/projectCategories/arrange') }}" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-sort-numeric-up"></i>
                        <span class="m-nav__link-text">ترتيب</span>
                    </a>
                    @endif
                    @if(\Helper::checkRules('charts-project-category'))
                    <a href="{{ URL::to('/projectCategories/charts') }}" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-project-category'))
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/projectCategories') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-project-category') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-project-category') }}">
        <!--begin: Datatable-->
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ asset('/assets/components/projectCategories-datatables.js')}}"></script>           
@endsection
