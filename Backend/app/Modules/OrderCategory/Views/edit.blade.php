...
@section('title','تصنيفات الخدمات - تعديل')
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="{{ URL::to('/orderCategories/update/'.$data->data->id) }}">  
                    @csrf
