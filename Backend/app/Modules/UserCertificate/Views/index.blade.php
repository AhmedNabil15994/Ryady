                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_1" placeholder="تاريخ البدء"  name="start_date" value="{{ Request::get('start_date') }}" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_1" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_3" placeholder="تاريخ الانتهاء"  name="start_date" value="{{ Request::get('start_date') }}" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_3" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ asset('/assets/components/userCertificates-datatables.js')}}"></script>           
@endsection
