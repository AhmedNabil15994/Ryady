...
<html lang="en">
    <head>
        ...
        <title>{{ $title }} - شهادة العضوية</title>
            ...
            <div class="row last">
                ...
                <div class="col-xs-10">
                    ...
                    <div class="row" style="margin-top: 100px;">
                        <div class="row first">
                            <img class="image" src="{{ URL::to('/assets/images/logo.png') }}" alt="">
                        </div>
                        <div class="col-xs-12">
                            <p class="light-bold certifies text-right" dir="rtl">يشهد مكتب محترف الأعمال بأن الأستاذ /</p>
                        </div>
                        <div class="col-xs-12 text-center">
                            <p class="light-bold name"> {{ $user }}</p>
                        </div>
                        <div class="col-xs-12" style="margin-top: 50px;">
                            <p class="details text-right">عضو في الشاب الريادي للفترة من {{ $start_date }} الي {{ $end_date }}</p>
                        </div>
                    </div>
                    {{-- <div class="row" style="margin-top: 100px;">
                        <div class="col-xs-12 footer text-left">
                            <div class="col-xs-3 text-center">
                                <b class="second">التاريخ</b>
