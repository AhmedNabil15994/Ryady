...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-project'))
    ...
    <div class="card-body">
                    ...
                    <div class="card-body">
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>العنوان:</label>
                                    <input type="text" class="form-control m-input" data-col-index="3" name="address" value="{{ Request::get('address') }}">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/projects') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-project') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-project') }}">
        <!--begin: Datatable-->
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ asset('/assets/components/projects-datatables.js')}}"></script>           
