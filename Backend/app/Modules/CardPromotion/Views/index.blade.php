                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control m-input" data-col-index="2" name="name" value="{{ Request::get('name') }}">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>كود البطاقة:</label>
                                    <input type="text" class="form-control m-input" data-col-index="3" name="code" value="{{ Request::get('code') }}">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_3" placeholder="تاريخ البدء"  name="start_date" value="{{ Request::get('start_date') }}" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_3" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_5" placeholder="تاريخ الانتهاء"  name="end_date" value="{{ Request::get('end_date') }}" data-col-index="7" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_5" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ asset('/assets/components/cardPromotions-datatables.js')}}"></script>           
@endsection
