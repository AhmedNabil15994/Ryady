                ...
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="{{ URL::to('/memberships/update/'.$data->data->id) }}">  
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="price" value="{{ $data->data->price }}" maxlength="" placeholder="">
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  {{ $data->data->created_at }}</span>
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control m-input" type="number" name="period" value="{{ $data->data->period }}" maxlength="" placeholder="">
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="discount_price" value="{{ $data->data->discount_price }}" maxlength="" placeholder="">
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  {{ $data->data->created_at }}</span>
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input id="example-color-input" class="form-control m-input" type="color" name="color" value="{{ $data->data->color }}">
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  {{ $data->data->created_at }}</span>
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
