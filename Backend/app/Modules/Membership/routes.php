...
Route::group(['prefix' => '/memberships'] , function () {
    ...
    Route::post('/add/uploadImage', 'MembershipControllers@uploadImage');
    Route::post('/edit/{id}/editImage', 'MembershipControllers@uploadImage');
    Route::post('/edit/{id}/deleteImage', 'MembershipControllers@deleteImage');
});