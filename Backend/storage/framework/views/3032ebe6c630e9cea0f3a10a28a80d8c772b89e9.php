<?php $__env->startSection('title','كوبونات الخصم'); ?>
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-coupon')): ?>
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <select name="discount_type" class="form-control m-input">
                                        ...
                                        <option value="1" <?php echo e(Request::get('discount_type') == 1 ? 'selected' : ''); ?>>قيمة محددة</option>
                                        <option value="2" <?php echo e(Request::get('discount_type') == 2 ? 'selected' : ''); ?>>نسبة مئوية</option>
                                    </select>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>قيمة الخصم:</label>
                                    <input type="text" class="form-control m-input" name="discount_value" value="<?php echo e(Request::get('discount_value')); ?>">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <select name="valid_type" class="form-control m-input">
                                        <option value="">حدد اختيارك</option>
                                        <option value="1" <?php echo e(Request::get('valid_type') == 1 ? 'selected' : ''); ?>>عدد مرات استخدام</option>
                                        <option value="2" <?php echo e(Request::get('valid_type') == 2 ? 'selected' : ''); ?>>لتاريخ معين</option>
                                    </select>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/coupons')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-coupon')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-coupon')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/coupons-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Coupon/Views/index.blade.php ENDPATH**/ ?>