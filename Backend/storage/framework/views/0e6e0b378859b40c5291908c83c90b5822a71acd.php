<?php $__env->startSection('title','القوائم العلوية - تعديل'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/topMenu')); ?>" class="text-muted">القوائم العلوية</a>
                    </li>
                    <li class="breadcrumb-item">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    <?php if(\Helper::checkRules('add-topMenu')): ?>
                    <a href="<?php echo e(URL::to('/topMenu/add')); ?>" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-plus"></i>
                        <span class="m-nav__link-text">اضافة</span>
                    </a>
                    <?php endif; ?>
                    <?php if(\Helper::checkRules('sort-topMenu')): ?>
                    <a href="<?php echo e(URL::to('/topMenu/arrange')); ?>" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-sort-numeric-up"></i>
                        <span class="m-nav__link-text">ترتيب</span>
                    </a>
                    <?php endif; ?>
                    <?php if(\Helper::checkRules('charts-topMenu')): ?>
                    <a href="<?php echo e(URL::to('/topMenu/charts')); ?>" class="dropdown-item">
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/topMenu/update/'.$data->data->id)); ?>">  
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <select name="page_id" class="form-control select2" id="kt_select2_1">
                                <option value="0" <?php echo e($data->data->page_id == 0 ? 'selected' : ''); ?>>صفحة خارجية</option>
                                ...
                                <option value="<?php echo e($page->id); ?>" <?php echo e($data->data->page_id == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control m-input" type="text" name="link" value="<?php echo e($data->data->link); ?>" maxlength="" placeholder="">
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  <?php echo e($data->data->created_at); ?></span>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/TopMenu/Views/edit.blade.php ENDPATH**/ ?>