<?php $__env->startSection('title','مميزات العضويات'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/features')); ?>" class="text-muted">مميزات العضويات</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">مميزات العضويات</h3>
        </div>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Feature/Views/index.blade.php ENDPATH**/ ?>