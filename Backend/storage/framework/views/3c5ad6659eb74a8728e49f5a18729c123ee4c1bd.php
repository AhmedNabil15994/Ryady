<?php $__env->startSection('title','مميزاتنا - تعديل'); ?>
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/ourAdvantages/update/'.$data->data->id)); ?>">  
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Advantage/Views/edit.blade.php ENDPATH**/ ?>