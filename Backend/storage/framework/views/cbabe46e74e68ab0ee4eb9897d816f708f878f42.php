<?php $__env->startSection('title','مجموعات المشرفين - تعديل'); ?>
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/groups/update/'.$data->data->id)); ?>">  
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    ...
                                    <input type="checkbox" <?php echo e($data->data->permissions != '' && in_array($onePermission['title'],$data->data->permissions) ? 'checked' : ''); ?> name="<?php echo e($onePermission['title']); ?>" value="<?php echo e($onePermission['modulePermissions']); ?>" />
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <select name="admin_privs" class="form-control mb-5 select2" id="kt_select2_1">
                                <option value="0" <?php echo e($data->data->admin_privs == 0 ? 'selected' : ''); ?>>لا</option>
                                <option value="1" <?php echo e($data->data->admin_privs == 1 ? 'selected' : ''); ?>>نعم</option>
                            </select>
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  <?php echo e($data->data->created_at); ?></span>
                        </div>
                    </div>      
...
<!--end::Card-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Group/Views/edit.blade.php ENDPATH**/ ?>