	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/ourAdvantages*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/benefits*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/cities*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/pages*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/slider*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/targets*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-advantages')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/ourAdvantages*'))); ?> " aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/ourAdvantages')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">مميزاتنا</span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-benefits')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/benefits*'))); ?> " aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/benefits')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                ...
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/userCards*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/userRequests*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/cardPromotions*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/userCertificates*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-user-certificates')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/userCertificates*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/userCertificates')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                ...
                <?php if(\Helper::checkRules('list-user-members')): ?>
                ...
                <?php if(\Helper::checkRules('list-blogs,list-blog-categories')): ?>
                <li class="menu-item menu-item-submenu <?php echo e(Active(URL::to('/blogs*'),'menu-item-open active')); ?> <?php echo e(Active(URL::to('/blogCategories*'),'menu-item-open active')); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <?php if(\Helper::checkRules('list-blogs')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/blogs*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/blogs')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
                                    <span class="menu-text">المدونة</span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(\Helper::checkRules('list-blog-categories')): ?>
                            <li class="menu-item <?php echo e(Active(URL::to('/blogCategories*'))); ?>" aria-haspopup="true">
                                <a href="<?php echo e(URL::to('/blogCategories')); ?>" class="menu-link ">
                                    <i class="menu-bullet menu-bullet-dot"></i>
...
<!--end::Aside--><?php /**PATH /var/www/Server/Projects/Ryady/Backend/resources/views/Layouts/sidebar.blade.php ENDPATH**/ ?>