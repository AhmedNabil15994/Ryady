<?php $__env->startSection('title','القوائم الجانبية - اضافة'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/sideMenu/add')); ?>" class="text-muted">اضافة</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/sideMenu/create')); ?>">  
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            <label class="label label-danger label-pill label-inline mr-2" style="margin-bottom: 20px;">اسم الصفحه</label>
                            <select name="page_id" class="form-control mb-5 select2" id="kt_select2_1">
                                <option value="0" <?php echo e(old('page_id') == 0 ? 'selected' : ''); ?>>صفحة خارجية</option>
                                ...
                                <option value="<?php echo e($page->id); ?>" <?php echo e(old('page_id') == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            <label class="label label-danger label-pill label-inline mr-2" style="margin-bottom: 20px;">رابط خارجى</label>
                            <input type="hidden" name="status" value="">
                            <input class="form-control m-input" type="text" name="link" value="<?php echo e(old('link')); ?>" maxlength="" placeholder="">
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
...
<!--end::Card-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/SideMenu/Views/add.blade.php ENDPATH**/ ?>