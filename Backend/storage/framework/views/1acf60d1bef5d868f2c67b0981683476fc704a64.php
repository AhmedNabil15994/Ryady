<?php $__env->startSection('title','الاعضاء المحظورة'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/blockedUsers')); ?>" class="text-muted">الاعضاء المحظورة</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    <?php if(\Helper::checkRules('sort-blockedUser')): ?>
                    <a href="<?php echo e(URL::to('/blockedUsers/arrange')); ?>" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-blockedUser')): ?>
    ...
    <div class="card-body">
                    ...
                    <div class="card-body">
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>IP :</label>
                                    <input type="text" class="form-control m-input" data-col-index="2" name="ip_address" value="<?php echo e(Request::get('ip_address')); ?>" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_1" placeholder="من"  name="from" value="<?php echo e(Request::get('from')); ?>" data-col-index="3" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_1" />
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_2" placeholder="الي"  name="to" value="<?php echo e(Request::get('to')); ?>" data-col-index="3" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_2" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/blockedUsers')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-blockedUser')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-blockedUser')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/blockedUsers-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/BlockedUser/Views/index.blade.php ENDPATH**/ ?>