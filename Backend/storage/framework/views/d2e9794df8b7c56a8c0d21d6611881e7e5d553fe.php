...
<div class="card card-custom">
    ...
    <div class="card-body">
                    ...
                    <div class="card-body">
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>العضوية القديمة:</label>
                                    <select name="from_membership_id" class="form-control m-input">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>العضوية الجديدة:</label>
                                    <select name="to_membership_id" class="form-control m-input">
                                        <option value="">حدد اختيارك</option>
                                        <?php $__currentLoopData = $data->memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($membership->id); ?>"><?php echo e($membership->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <select name="status" class="form-control m-input">
                                        ...
                                        <option value="2">تم الارسال</option>
                                        <option value="3">تأجيل</option>
                                        <option value="4">تم التسليم</option>
                                        <option value="5">عدم الرد</option>
                                ...
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_3" placeholder="تاريخ البدء"  name="start_date" value="<?php echo e(Request::get('start_date')); ?>" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_3" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_5" placeholder="تاريخ الانتهاء"  name="end_date" value="<?php echo e(Request::get('end_date')); ?>" data-col-index="7" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_5" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
        ...
        <table class="table table-separate table-hover table-bordered table-head-custom table-foot-custom table-checkable" id="kt_datatable">
            <thead>
                <tr>
                    ...
                    <th>اسم المستخدم</th>
                    <th>كود الطباقة</th>
                    <th>العضوية القديمة</th>
                    <th>العضوية الجديدة</th>
                    <th>تاريخ البدء</th>
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                <button type="button" class="btn btn-block btn-danger delete">حذف</button>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<script src="<?php echo e(asset('/assets/components/cardPromotions-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/CardPromotion/Views/index.blade.php ENDPATH**/ ?>