<?php $__env->startSection('title','البطاقات - اضافة'); ?>
                ...
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/memberships/create')); ?>">  
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control mb-5" type="number" name="period" value="<?php echo e(old('period')); ?>" maxlength="" placeholder="">
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input id="example-color-input" class="form-control m-input" type="color" name="color" value="<?php echo e(old('color')); ?>">
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    ...
                                    <input type="checkbox" name="features[]" value="<?php echo e($oneFeature->id); ?>" />
...
<!--end::Card-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Membership/Views/add.blade.php ENDPATH**/ ?>