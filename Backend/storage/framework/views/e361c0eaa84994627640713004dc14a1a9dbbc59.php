<?php $__env->startSection('title','البطاقات'); ?>
                    ...
                    <div class="card-body">
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>السعر:</label>
                                    <input type="text" class="form-control m-input" name="price" value="<?php echo e(Request::get('price')); ?>">
                                    <br>
                                </div>
                            </div>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/Membership/Views/index.blade.php ENDPATH**/ ?>