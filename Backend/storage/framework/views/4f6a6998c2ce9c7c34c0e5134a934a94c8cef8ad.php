<?php $__env->startSection('title','اعضاء مجتمع الشاب الريادي - تعديل'); ?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/userMembers')); ?>" class="text-muted">اعضاء مجتمع الشاب الريادي</a>
                    </li>
                    <li class="breadcrumb-item">
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('/userMembers/update/'.$data->data->id)); ?>">  
                    <?php echo csrf_field(); ?>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            <label class="label label-danger label-pill label-inline mr-2 mt-15" style="margin-bottom: 20px;">المستخدم</label>
                     ...
                     <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <select name="shown" class="form-control select2">
                                <option value="0" <?php echo e($data->data->shown == 0 ? 'selected' : ''); ?>>لا</option>
                                <option value="1" <?php echo e($data->data->shown == 1 ? 'selected' : ''); ?>>نعم</option>
                            </select>   
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/UserMember/Views/edit.blade.php ENDPATH**/ ?>