                ...
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="<?php echo e(URL::to('projects/update/'.$data->data->id)); ?>">  
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <select class="form-control m-input select2" name="type">
                                ...
                                <option value="تحت التأسيس" <?php echo e($data->data->type == 'تحت التأسيس' ? 'selected' : ''); ?>>تحت التأسيس</option>
                                <option value="قائم" <?php echo e($data->data->type == 'قائم' ? 'selected' : ''); ?>>قائم</option>
                                <option value="متعثر" <?php echo e($data->data->type == 'متعثر' ? 'selected' : ''); ?>>متعثر</option>
                                <option value="@" <?php echo e($data->data->type == 'أخري' ? 'selected' : ''); ?>>أخري</option>
                            </select>
                            <input type="text" class="form-control mt-5 mb-5 <?php echo e($data->data->type == 'أخري' ? '' : 'hidden'); ?>" value="<?php echo e($data->data->type_text); ?>" name="type_text" placeholder="أخري :" />
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  <?php echo e($data->data->created_at); ?></span>
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control mb-5 m-input" type="text" name="coupons" value="<?php echo e($data->data->coupons); ?>" maxlength="" placeholder="">
                            <span class="m-form__help LastUpdate">تم الحفظ فى :  <?php echo e($data->data->created_at); ?></span>
                        </div>
                    </div>
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
