<?php $__env->startSection('title','تصنيفات الخدمات'); ?>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h3 class="text-dark font-weight-bold my-1 mr-5 m-subheader__title--separator">تصنيفات الخدمات</h3>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(URL::to('/orderCategories')); ?>" class="text-muted">تصنيفات الخدمات</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="main-menu dropdown dropdown-inline">
                ...
                <div class="dropdown-menu" dropdown-toggle="hover">
                    <?php if(\Helper::checkRules('add-order-category')): ?>
                    <a href="<?php echo e(URL::to('/orderCategories/add')); ?>" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-plus"></i>
                        <span class="m-nav__link-text">اضافة</span>
                    </a>
                    <?php endif; ?>
                    <?php if(\Helper::checkRules('sort-order-category')): ?>
                    <a href="<?php echo e(URL::to('/orderCategories/arrange')); ?>" class="dropdown-item">
                        <i class="m-nav__link-icon fa fa-sort-numeric-up"></i>
                        <span class="m-nav__link-text">ترتيب</span>
                    </a>
                    <?php endif; ?>
                    <?php if(\Helper::checkRules('charts-order-category')): ?>
                    <a href="<?php echo e(URL::to('/orderCategories/charts')); ?>" class="dropdown-item">
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">تصنيفات الخدمات</h3>
        </div>
        <div class="card-toolbar">
            <?php if(\Helper::checkRules('edit-order-category')): ?>
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::to('/orderCategories')); ?>" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="<?php echo e(\Helper::checkRules('edit-order-category')); ?>">
        <input type="hidden" name="data-cols" value="<?php echo e(\Helper::checkRules('delete-order-category')); ?>">
        <!--begin: Datatable-->
...
<script src="<?php echo e(asset('/assets/components/orderCategories-datatables.js')); ?>"></script>           
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Ryady/Backend/app/Modules/OrderCategory/Views/index.blade.php ENDPATH**/ ?>