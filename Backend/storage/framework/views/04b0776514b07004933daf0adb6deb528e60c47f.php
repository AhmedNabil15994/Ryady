                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="<?php echo e(URL::current()); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_1" placeholder="تاريخ البدء"  name="start_date" value="<?php echo e(Request::get('start_date')); ?>" data-col-index="4" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_1" />
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>تاريخ الانتهاء:</label>
                                    <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_3" placeholder="تاريخ الانتهاء"  name="end_date" value="<?php echo e(Request::get('end_date')); ?>" data-col-index="5" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_3" />
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>الحالة:</label>
